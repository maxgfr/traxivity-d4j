...
public class MLPClassifierLinear {
    ...
    public void loadTrainingData () throws IOException, InterruptedException {
    ...
    public void loadEvaluationData () throws IOException, InterruptedException {
    ...
    public void dispRes (MultiLayerConfiguration conf, DataSetIterator trainIter, DataSetIterator testIter) {
